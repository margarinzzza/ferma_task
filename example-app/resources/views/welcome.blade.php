...
<head>
    ...
    <link rel="stylesheet" href="../../public/css/task_css/reset.css" />
    <link rel="stylesheet" href="../../public/css/task_css/fonts.css" />
    <link rel="stylesheet" href="../../public/css/task_css/jquery.bxslider.css" />
    <link rel="stylesheet" href="../../public/css/task_css/style.css" />
    <link rel="stylesheet" href="../../public/css/task_css/dialog.css" />
    <link rel="stylesheet" href="../../public/css/task_css/jquery.mCustomScrollbar.min.css" />
            ...
            <header class="header">
                <div class="headerNav">
                    <ul class="center">
                        ...
                        <li>
                            <a href="{{route('admin_panel')}}">Панель администратора</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="contentPage">
                <div class="productPage productPage_objectS">
                    ...
                    <div class="productPage_text">
                        Производственная Компания «АРТа» существует уже более 10-ти лет, успешно работая на рынке
                        производства модульных зданий и металлоконструкций.
                    </div>
                    <div class="productPage_nav">
                        <div class="productPage_navBlock">
                            <ul class="productPage_menu">
                                <li class="active">
                                    <a class="productPage_navTitle" href="{{ route('index') }}">
                                        Все объекты
                                    </a>
                                </li>
                                @foreach ($categories as $category)
                                    <li>
                                        <a class="productPage_navTitle"
                                            href="{{ route('filter_objects', $category['name']) }}">{{ $category['name'] }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                        ...
                        <div class="objectsSection_list objectsSection_product">
                            @foreach ($objects as $object)
                                <div class="objectsSection_listBlock">
                                    <a class="objectsSection_img"
                                        style="background-image:url('../../storage/app/{{ $object['img'] }}')"
                                        href="object/{{ $object['id'] }}"></a>
        ...
        <footer class="footer">
            <div class="center">
                <a class="footerLogo" href="">
                    <img src="../../storage/img/footerLogo.png" alt="" />
                </a>
                <div class="footerTel">
