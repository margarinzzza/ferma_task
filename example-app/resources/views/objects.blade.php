				...
				<div class="productPage_nav">
					<div class="productPage_navBlock">
						<ul class="productPage_menu">
							...
							<li>
								<a class="productPage_navTitle" href="">Торговля</a>
							</li>
							<li>
								<a class="productPage_navTitle" href="">Агрокомплекс</a>
							</li>
							<li>
								<a class="productPage_navTitle" href="">Модульные здания</a>
							</li>
							<li>
								<a class="productPage_navTitle" href="">
									Быстровозводимые
				...
				<div class="productPage_content">
					<div class="objectsSection_list objectsSection_product">
						<div class="objectsSection_listBlock">
							<a class="objectsSection_img" style="background-image:url('/img/simpleToComplex _img1.jpg')" href="object.html"></a>
							<div class="objectsSection_text">Производственный цех</div>
						</div>
						<div class="objectsSection_listBlock">
							<a class="objectsSection_img" style="background-image:url('/img/simpleToComplex _img2.jpg')" href="#"></a>
							<div class="objectsSection_text">Магазин</div>
						</div>
						<div class="objectsSection_listBlock">
							<a class="objectsSection_img" style="background-image:url('/img/simpleToComplex _img3.jpg')" href="#"></a>
							<div class="objectsSection_text">Склад</div>
						</div>
						<div class="objectsSection_listBlock">
							<a class="objectsSection_img" style="background-image:url('/img/simpleToComplex _img3.jpg')" href="#"></a>
							<div class="objectsSection_text">Склад</div>
						...
						<div class="objectsSection_listBlock">
							<a class="objectsSection_img" style="background-image:url('/img/simpleToComplex _img1.jpg')" href="#"></a>
							<div class="objectsSection_text">Производственный цех</div>
						</div>
						<div class="objectsSection_listBlock">
							<a class="objectsSection_img" style="background-image:url('/img/simpleToComplex _img2.jpg')" href="#"></a>
